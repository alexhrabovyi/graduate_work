...
{
    const education_mobile_slider = new Swiper(".education-packs-for-adult__cards-block_mobile", {
        slidesPerView: "auto",
        centeredSlides: true,
        spaceBetween: 30,
        initialSlide: 1,
    ...
    class EducationPacks {
        ...
        setupCardsBlockHeight() {
            ...
            console.log(this.cardsBlockHeight);
        }
        ...
        cardsShowHandler(id) {
            ...
            if (this.displayedCardsId != 0) {
                ...
                education_mobile_slider.updateSlides()
            }
        ...
        setupMessages(id, button) {
            ...
            let messagesNext = this.educationSection.querySelectorAll(`[data-ed-message="${id + 1}"]`);
    ...
    new EducationPacks({
        education_section_selector: ".education-packs-for-adult_desktop",
    ...
    new EducationPacks({
        education_section_selector: ".education-packs-for-adult_mobile",
